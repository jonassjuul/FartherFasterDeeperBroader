...
def sample_topology(N_experiments,cascade_data,treatment_name = 'TRUE',control_name = 'FALSE',also_below_3 = True) :
    go_ahead = False        
...
def import_truefalsedata() :
    ...
    cascade_data_categories = {'Politics':{},'Other': {}}
...
def KS_make_table(cascades_unsampled,p_vec_sampled,features,quantile) :
...
def get_network_data(cascades_IC_networks,cascades_IC_networks_sizes,IC_networks_files,IC_networks_files_measure,keys,school) :
    ...
    #IC_networks_files = {'Cornell':{35:'Cascades_on_network_ICMODELCornell5_Rspread0.350000_MinimumCascadeSize1.txt',
    #                            40:'Cascades_on_network_ICMODELCornell5_Rspread0.400000_MinimumCascadeSize1.txt'},
    #                    'MSU':{35:'Cascades_on_network_ICMODELMSU24_Rspread0.350000_MinimumCascadeSize1.txt',
    #                        40:'Cascades_on_network_ICMODELMSU24_Rspread0.400000_MinimumCascadeSize1.txt'},
    #                    'Texas':{35:'Cascades_on_network_ICMODELTexas84_Rspread0.350000_MinimumCascadeSize1.txt',
    #                            40:'Cascades_on_network_ICMODELTexas84_Rspread0.400000_MinimumCascadeSize1.txt'}}
...
def FalseTrue_ccdfs(topology_TRUE,topology_FALSE,example_cascades,median_timesingle,median_time,time05,time95,destinations) :
    ...
    #seca01 = ax01.secondary_yaxis('left')
    #seca01.set_ylabel('B',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)    
    ...
    #seca02 = ax02.secondary_yaxis('left')
    #seca02.set_ylabel('C',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  
    ...
    #seca10 = ax10.secondary_yaxis('left')
    #seca10.set_ylabel('E',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  
    ax10.set_ylabel('F',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  

    plt.text(0.04, 0.29, 'CCDF',rotation=90, fontsize=SMALL_SIZE, transform=plt.gcf().transFigure)
    ...
    if (hide_CCDF_yticklabels==True) :
        ...
        ax11.set_ylabel('')
    #seca11 = ax11.secondary_yaxis('left')
    #seca11.set_ylabel('F',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  
    ...
    #seca12 = ax12.secondary_yaxis('left')
    #seca12.set_ylabel('G',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight) 
    ...
    im_ax13.axis('off')
    #ax12.xaxis.set_ticks_position('both') # THIS IS THE ONLY CHANGE
    ...
    #seca14 = ax13.secondary_yaxis('left')
    #seca14.set_ylabel('H',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  
    ...
    plt.text(0.807, 0.26, 'Minutes',rotation=90, fontsize=SMALL_SIZE, transform=plt.gcf().transFigure)
    ...
    #plt.tight_layout(h_pad=vertical_space_between_subplots)#h_pad=vertical_space_between_subplots,w_pad = horizontal_space_between_subplots)
...
def FalseTrue_joint(cascade_scatter,cascade_lines,destinations) :
   ...
   # General: 
    ...
    #plt.subplots(figsize=figsize_joint,sharex=True)
    ...
    #ax02 = plt.subplot2grid(plot_dimension_joint,(0,2),rowspan=1,colspan=1)
    ...
    #for veracity in ['FALSE','TRUE']:    
        #ax02.plot(cascade_lines[veracity]['size'],cascade_lines[veracity][plot_this][50],ls='-',linewidth=.5,c=marker_color[veracity],alpha=line_alpha)

    #    ax01.fill_between(cascade_lines[veracity]['size'],cascade_lines[veracity][plot_this][5],cascade_lines[veracity][plot_this][95],color=marker_color[veracity],alpha=marker_alpha)
    ...
    #ylim_new = (np.log10(ylim[0]),ylim[1])
...
def rootedtrees(plot_vecs,keys,colors,p_combined,p_arr,model_name,destinations) :
    ...
    #ax00 = plt.subplot2grid(plot_dimension,(0,2),rowspan=1,colspan=1)
    size = 3
...
def PoliticalOther_ccdfs(topology_Other,topology_Politics,example_cascades_categories,median_timesingle_categories,median_time_categories,time05_categories,time95_categories,destinations) :
    ...
    plotthis = sorted(topology_Other['%s'%'Other']['%s'%feature])
    ax00.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='b',linewidth=FT_linewidth,label='Other')


    plotthis = sorted(topology_Politics['%s'%'Politics']['%s'%feature])
    ax00.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='r',linewidth=FT_linewidth,label='Politics')
    ...
    #secaxy = ax00.secondary_yaxis('left')
    ax00.set_ylabel('A',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)
    #secaxy.set_yticks([])
    ...
    #ax03.set_ylabel(col3_ylabel)

    #seca03 = ax03.secondary_yaxis('left')
    ax03.set_ylabel('D',verticalalignment='top',y=1,rotation=0,fontsize=MEDIUM_SIZE,fontweight=inset_fontweight)  
    ...
    plotthis = sorted(example_cascades_categories['%s'%'Other']['%s'%feature])
    ax10.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='b',linewidth=FT_linewidth)


    plotthis = sorted(example_cascades_categories['%s'%'Politics']['%s'%feature])
    ax10.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='r',linewidth=FT_linewidth)
    ax10.set_xscale('log')
    ax10.set_yscale('log')
    ax10.set_xlim([1,maxx_col0])
    ...
    ax13.plot(median_time_categories['sizes'],median_time_categories['Other'],color='b',linewidth=FT_linewidth)
    ax13.plot(median_time_categories['sizes'],median_time_categories['Politics'],color='r',linewidth=FT_linewidth)
    ax13.fill_between(median_time_categories['sizes'],time05_categories['Politics'],time95_categories['Politics'],color='r',alpha=alpha90)
    ...
    #seca13 = ax13.secondary_yaxis('left')
    ...
    for destination in destinations :
        plt.savefig(destination+'FigPoliticsOther.png',dpi=400)

# Political / other false
def PoliticalOther_5ccdfs(topology_Other,topology_Politics,example_cascades_categories,median_timesingle_categories,median_time_categories,time05_categories,time95_categories,destinations) :
    ...
    col1_xlabel = 'Cascade Max-Breadth'
    col2_xlabel = 'Cascade Depth'#'Cascade Virality'
    col3_xlabel = 'Cascade Virality'#'Cascade Virality'
    ...
    ax04.plot(median_timesingle_categories['Othersizes'],median_timesingle_categories['Other'],'b',linewidth=FT_linewidth)
    ax04.plot(median_timesingle_categories['Politicssizes'],median_timesingle_categories['Politics'],'r',linewidth=FT_linewidth)
    ...
    ax14.plot(median_time_categories['sizes'],median_time_categories['Other'],color='b',linewidth=FT_linewidth)
    ax14.plot(median_time_categories['sizes'],median_time_categories['Politics'],color='r',linewidth=FT_linewidth)
    ax14.fill_between(median_time_categories['sizes'],time05_categories['Politics'],time95_categories['Politics'],color='r',alpha=alpha90)
...
def four_column_CCDF(example_cascades_full_data,example_cascades_subsampled,keys,plot_colors,model_name,fig_name,destinations,school=None) :
    ...
    col0_xticks = 10**np.arange(len(str(int(maxx_col0))))#[1,10,100,1000]
    col1_xticks = 10**np.arange(len(str(int(maxx_col1))))#[1,10,100,1000]
    col2_xticks = 10**np.arange(len(str(int(maxx_col2))))#[1,10,100,1000]
    col3_xticks = 10**np.arange(len(str(int(maxx_col3))))#[1,10,100,1000]

    print(col3_xticks)
    #col1_xticks = [1,10,100]#col0_xticks
    #col2_xticks = [1,10,100]#[1,10,100]
    ...
    # AXIS LIMS
    #maxx_col0 = max(3200,max(example_cascades_full_data[keys[0]]['size'],example_cascades_full_data[keys[1]]['size']))
    #maxx_col0 = max(max(example_cascades_full_data[keys[0]]['size'],example_cascades_full_data[keys[1]]['size']))+1000
    #maxx_col1 = 1200
    #maxx_col1 = max(max(example_cascades_full_data[keys[0]]['max_breadth'],example_cascades_full_data[keys[1]]['max_breadth']))+1000
    #maxx_col2 = 100#100
    #maxx_col3 = 70000
...
def six_column_CCDF(example_cascades_SIR08only,example_cascades_SIR09only,example_cascades_IC08only,example_cascades_IC09only,example_cascades_SIR,example_cascades_IC,example_cascades_ICSIR08,destinations) :
    ...
    # NOW PLOT.
    plt.style.use('default')
    figsize2 = (cm_to_inch(14/4*6),cm_to_inch(6))
    ...
    ax00.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C0',linewidth=FT_linewidth,label=r'$SIR, R_0=0.8$')


    plotthis = sorted(example_cascades_SIR09only[0.9]['%s'%feature])
    ax00.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C1',linewidth=FT_linewidth,label=r'$SIR, R_0=0.9$')
    ...
    ax02.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C2',linewidth=FT_linewidth,label=r'$IC, R_0=0.8$')


    plotthis = sorted(example_cascades_IC09only[0.9]['%s'%feature])
    ax02.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C4',linewidth=FT_linewidth,label=r'$IC, R_0=0.9$')
    ...
    plotthis = sorted(example_cascades_IC08only[0.8]['%s'%feature])
    ax04.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C2',linewidth=FT_linewidth,label=r'$IC, R_0=0.8$')


    plotthis = sorted(example_cascades_SIR08only[0.8]['%s'%feature])
    ax04.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C0',linewidth=FT_linewidth,label=r'$SIR, R_0=0.8$')
    ...
    im_ax10 = inset_axes(ax10,height="30%", width="30%", loc=3) # center, you can check the different codes in plt.legend?
    im_ax10.imshow(im_size)
    im_ax10.axis('off')
    ...
    im_ax11 = inset_axes(ax11, height="30%", width="30%",loc=3) # center, you can check the different codes in plt.legend?
    im_ax11.imshow(im_max_breadth)
    im_ax11.axis('off')
    ...
    ax12.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C2',linewidth=FT_linewidth,label=r'$IC, R_0=0.8$')


    plotthis = sorted(example_cascades_IC[0.9]['%s'%feature])
    ax12.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C4',linewidth=FT_linewidth,label=r'$SIR, R_0=0.8$')
    ...
    im_ax12 = inset_axes(ax12,height="30%",width="30%", loc=3) # center, you can check the different codes in plt.legend?
    ...
    im_ax13 = inset_axes(ax13,height="30%", width="30%",loc=3) # center, you can check the different codes in plt.legend?
    ...
    ax14.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C2',linewidth=FT_linewidth,label=r'$IC, R_0=0.8$')


    plotthis = sorted(example_cascades_ICSIR08['SIR']['%s'%feature])
    ax14.plot(ccdf_x(plotthis),ccdf_y(plotthis),color='C0',linewidth=FT_linewidth,label=r'$SIR, R_0=0.8$')
    ...
    # INSERT SMALL IMAGE
    im_ax14 = inset_axes(ax14,height="30%", width="30%", loc=3) # center, you can check the different codes in plt.legend?
    ...
    # INSERT SMALL IMAGE
    im_ax15 = inset_axes(ax15,height="30%", width="30%",loc=3) # center, you can check the different codes in plt.legend?
    ...
    color_face = '#F7F7F7'
    ax02.set_facecolor(color_face)    
    ax03.set_facecolor(color_face)
    ax12.set_facecolor(color_face)
    ax13.set_facecolor(color_face)
    ...
    for destination in destinations : 
        plt.savefig(destination+'FigSIRIC_mix.png',dpi=400)
